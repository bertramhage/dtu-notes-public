---
Dato: 22/10/2024
Slides: "[[5. semester/02407 Stochastic processes/Slides/week7.pdf]]"
Teaching Notes: "[[lesson7.pdf]]"
Pensum: "[[0.2 phase–type distributions.pdf]]"
---
>[!info] Definition
...
>
>The initial probability vector is denoted by $(\alpha, \alpha_{m+1})$, where $\alpha$ is a vector. The pair $(\alpha,S)$ is called a representation for the phase-type distribution.
...
| Survival function     | $\alpha T^x1$     | $\alpha e^{Tx}1$   |
| Distribution function | $1-\alpha T^x1$   | $1-\alpha e^{Tx}1$ |
...
0 & S_x & 0 \\
0 & 0 & S_y\end{bmatrix},\quad l = \begin{bmatrix}0 \\
s_x \\
s_y\end{bmatrix}$$
